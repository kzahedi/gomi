...
func MorphologicalComputationW(pw2w1a1 sm.SparseMatrix) float64 {
	return sparse.ConditionalMutualInformationBase2(pw2w1a1)
}
...
func MorphologicalComputationA(pw2a1w1 sm.SparseMatrix) float64 {
	return sparse.ConditionalMutualInformationBase2(pw2a1w1)
}
...
func MorphologicalComputationCA(pw2w1, pw2a1 sm.SparseMatrix) float64 {
	return sparse.MutualInformationBase2(pw2w1) - sparse.MutualInformationBase2(pw2a1)
}
...
func MorphologicalComputationWA(pw2w1a1 sm.SparseMatrix) float64 {
	...
	return sparse.ConditionalMutualInformationBase2(pw2w1a1) - sparse.MutualInformationBase2(pw2a1)
}
...
func MorphologicalComputationWS(pw2w1s1 sm.SparseMatrix) float64 {
	...
	return sparse.ConditionalMutualInformationBase2(pw2w1s1) - sparse.MutualInformationBase2(pw2s1)
}
...
func MorphologicalComputationMI(pw2w1 sm.SparseMatrix, pa1s1 sm.SparseMatrix) float64 {
	return sparse.MutualInformationBase2(pw2w1) - sparse.MutualInformationBase2(pa1s1)
}
...
// // func MorphologicalComputationWp(pw2w1a1 sm.SparseMatrix, iterations int, eta bool) float64 {
...
// // 	return math.Log2(float64(abins)) - discrete.MutualInformationBase2(pa1s1)
// // }
