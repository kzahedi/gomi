...
func TestMorphologicalComputationW(t *testing.T) {
	...
	pw2w1a1 = discrete.Normalise3D(pw2w1a1)
...
func TestMorphologicalComputationA(t *testing.T) {
	...
	pw2a1w1 = discrete.Normalise3D(pw2a1w1)
...
func TestMorphologicalComputationCW(t *testing.T) {
	...
	pw2w1 = discrete.Normalise2D(pw2w1)
	pw2a1 = discrete.Normalise2D(pw2a1)
...
func TestMorphologicalComputationWS(t *testing.T) {
	...
	pw2w1s1 = discrete.Normalise3D(pw2w1s1)
	...
	pw2s1 = discrete.Normalise2D(pw2s1)
...
func TestMorphologicalComputationMI(t *testing.T) {
	...
	pw2w1 = discrete.Normalise2D(pw2w1)
	pa1s1 = discrete.Normalise2D(pa1s1)
...
func TestMorphologicalComputationIN(t *testing.T) {
	pa1s1 := discrete.Create2D(10, 10)
	for i := 0; i < 10; i++ {
		for j := 0; j < 10; j++ {
			pa1s1[i][j] = rand.Float64()
	...
	r := discrete.MorphologicalComputationIN(pa1s1)
	s := discrete.ConditionalEntropyBase2(pa1s1)

	if math.Abs(r-s) > 0.00001 {
		t.Errorf("MorphologicalComputationIN should be %f but is %f", s, r)
	}
	if r < 0.0 {
		t.Errorf("MorphologicalComputationIN should non-negativ but is %f", r)
	}
}
